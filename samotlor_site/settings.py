"""
Django settings for samotlor_site project.
...
SECRET_KEY = '5(0_*v&y75=4ovu-afu^md*nw_ezbgg7#0nk3j=g91gcil5nl7'
...
ALLOWED_HOSTS = ['naks-samotlor.minml.ru', 'samotlor.centrnaks.ru']
...
ROOT_URLCONF = 'samotlor_site.urls'
...
WSGI_APPLICATION = 'samotlor_site.wsgi.application'
